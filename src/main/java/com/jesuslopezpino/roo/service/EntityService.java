...
public abstract interface EntityService<Entity extends AbstractEntity, Repository extends AbstractRepository<Entity, QAbstractEntity>>
	...
	// * @return Product
	// */
	// public abstract Product addToProductosStock(Product product, Iterable<Long>
	/// productosStockToAdd);
	//
	/// **
	// * TODO Auto-generated method documentation
	...
	// * @return Product
	// */
	// public abstract Product removeFromProductosStock(Product product,
	...
	// * @return Product
	// */
	// public abstract Product setProductosStock(Product product, Iterable<Long>
	/// productosStock);
